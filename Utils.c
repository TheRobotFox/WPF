...
char isLetter(unsigned char Letter) {
	/*if (Letter == (unsigned char)'Ä') return 1;
	if (Letter == (unsigned char)'Ö') return 1;
	if (Letter == (unsigned char)'Ü') return 1;
	if (Letter == (unsigned char)'ä') return 1;
	if (Letter == (unsigned char)'ö') return 1;
	if (Letter == (unsigned char)'ü') return 1;
	if (Letter == (unsigned char)'ß') return 1;*/
